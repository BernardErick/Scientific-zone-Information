public class LinkedList {
    ...
    public LinkedList() //construtor padrao
    {
        primeiro = null;
        ultimo = null;
        tamanho = 0;
    }
    public LinkedList(int init) //construtor de 1 argumento inteiro
    {
        No novo = new No(init);
        primeiro = novo;
        ultimo = novo;
    ...
    public LinkedList(LinkedList lista) //construtor de 1 argumento de lista
    {
    ...
    public LinkedList(int[] vetor) //construtor de 1 argumento de lista
    {
    ...
    public No clonar()
    {
        LinkedList listaAux = new LinkedList(this);
    ...
    public void inserirListaPosicao(LinkedList lista,int pos)
    {
        int i = 0;
        No aux = primeiro;
        while(i <= pos)
